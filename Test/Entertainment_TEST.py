...
y = tf.nn.softmax(tf.matmul(hidden2, W_o) + b_o, name='y')  # 왜 softmax 를 사용 하지 않고 sigmoid 를 적용 했냐 하면, 근간이 되는 요소를 노출 하기 위해서 이다
...
saver.restore(sess, '/Users/Naver/tensorflow_save/save')
